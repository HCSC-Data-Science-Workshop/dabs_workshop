...
Opening a pull request will trigger a[workflow](../.github/workflows/ny_taxi_koeppen-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/staging/ny_taxi_koeppen/ny_taxi_koeppen-model)
* [Prod model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/prod/ny_taxi_koeppen/ny_taxi_koeppen-model)
. 

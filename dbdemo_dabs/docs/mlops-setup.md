...
git add README.md docs .gitignore ny_taxi_koeppen/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[ny_taxi_koeppen/databricks.yml](../ny_taxi_koeppen/databricks.yml) file.
...
Follow the instructions in [ny_taxi_koeppen/resources/README.md](../ny_taxi_koeppen/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../ny_taxi_koeppen/resources/README.md)  to propose, test, and deploy
